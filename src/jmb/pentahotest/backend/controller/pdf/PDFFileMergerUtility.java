 ...
 * 
 */
public class PDFFileMergerUtility {
     ...
     */
    public void addSources(List<File> sourcesList) {
    ...
    private void mergeAcroForm(PDFCloneUtility cloner, PDAcroForm destAcroForm, PDAcroForm srcAcroForm) throws IOException {
        ...
        if (srcFields != null) {
            ...
            while (srcFieldsIterator.hasNext()) {
                ...
                // If the form already has a field with this name then we need to rename this field to prevent merge conflicts.
